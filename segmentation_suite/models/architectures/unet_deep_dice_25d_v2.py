#!/usr/bin/env python3
"""
2.5D UNet Deep Dice v2 — Improved training stability.

Same architecture as unet_deep_dice_25d but with:
...
ARCHITECTURE_ID = 'unet_deep_dice_25d_v2'
ARCHITECTURE_NAME = 'UNet Deep Dice 2.5D v2 (Stable)'
ARCHITECTURE_DESCRIPTION = (
    "Improved 2.5D variant with stable training. Takes 3 z-slices (z-3, z, z+3) "
    "as input channels. Uses combined BCE+Dice loss, gradient clipping, and proper "
    "resume handling. Recommended over the original for new projects."
)
...
class UNetDeepDice25DV2(nn.Module):
    """
    2.5D U-Net with 3 input channels for z-context.
    Same architecture as UNetDeepDice25D — training improvements are in train_worker.
    """
